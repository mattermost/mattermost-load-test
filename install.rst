...
The load test parameters when running a test should be 

    ::
        export DBURL=""
        export PLATFORMURL="http://localhost:8065"
        export SOCKETURL="ws://localhost:8065"
        export BOLTFILE="cache.db"
        export DEVELOPMENT=false

        export THREADCOUNT="15000"
        export THREADOFFSET="0"
        export RAMPSEC="1000"
